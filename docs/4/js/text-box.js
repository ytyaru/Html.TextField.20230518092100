...
class TextBox extends HTMLElement {
    static #attrs = new Map([
        ...
        ['writing-mode-flag', ['horizontal', 'vertical', 'sideway', 'horizontal-tb', 'vertical-rl', 'vertical-lr', 'sideways-rl', 'sideways-lr']], 
        ['attr', ['id', 'name']],
    ...
    connectedCallback() {
        ...
        console.debug('textContent:', this.textContent)
        console.debug('innerHTML:', this.innerHTML)
//        console.debug(this.getAttributeNames())
